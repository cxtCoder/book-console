/*
    ...
    05. Handle Mobile Sidebar Scrolling Feature 
    06. Handle Clear Sidebar Selection & Hide Mobile Menu
    07. Handle IE Full Height Page Compatibility
...
var handleSidebarMenu2 = function() {
    ...
    var FirstTargetLi = $('.sidebar .nav > .has-sub');
    var AllTarget = $('.sidebar .nav > .has-sub > .sub-menu');
    
    $(AllTarget).show();
    $(FirstTargetLi).addClass("expand")
...
/* 07. Handle IE Full Height Page Compatibility - added in V1.6
------------------------------------------------ */
