<template>
    <div>
            ...
            <el-row>
                <el-col :span="13" :offset="4">
                    <el-form :model="bookForm" ref="bookForm" :rules="bookRules" label-position="right" label-width="100px">
                        ...
                        <el-form-item label="规格" prop="bookSubName">
                            <el-input v-model="bookForm.bookSubName"></el-input>
                        </el-form-item>
                        <el-form-item label="材质" prop="publishing">
                        ...
                        <el-form-item label="创作日期" prop="publishedDate">
        ...
        <el-dialog title="分类管理" :visible.sync="classifyVisible" :before-close="cancelClassify">
            <painting-classify :classify="classify"></painting-classify>
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    import paintingClassify from './paintingClassify.vue'
    ...
    export default {
        ...
        components: { vDistpicker, paintingClassify },
        data () {
            return {
                pickerOptions: {
                    disabledDate(time) {
                ...
                bookRules: {
                    ...
                    publishedDate: [
                        { type: 'date', required: true, message: '请选择创作日期', trigger: 'change' }
                    ],
                    classifyId: [
        ...
        methods: {
            ...
            returnPage() {
                this.$emit('update:showPage', 'paintingHome');
            },
            saveBookButton() {
                var _this = this;
